...
urlpatterns = [
    ...
    path('review/delete/<int:pk>/', login_required(views.ReviewDeleteView.as_view()), name='review_delete'),
    path('review/edit/<int:pk>/', login_required(views.ReviewUpdateView.as_view()), name='review_update'),
    ...
    path('review/edit/comment/<int:pk>/', login_required(views.CommentUpdateView.as_view()), name='comment_update'),
