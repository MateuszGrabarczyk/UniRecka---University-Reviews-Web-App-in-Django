...
from .models import Comment, CommentHistory, Review, ReviewHistory, University
...
class CommentModelTests(TestCase):
    ...
    def test_create_comment(self):
        comment = Comment.objects.create(
            description="This is a test comment.", review=self.review, user=self.user
        )
